...
<section id="models" class="events py-150 bg-dark2 t-center">
    ...
    <div class="container t-center">
        ...
        <h1 class="font-secondary uppercase white">
            2020 - Beyond The Return Edition
        </h1>
        <!-- Strips -->
        ...
        <p class="mt-25 white lh-30 fs-18">
            ...
            With the global pandemic the event was expected to be on a smaller scale because there were  not  going to be designers from other African countries flying in to participate.
            There were also limited travellers from the diaspora due to travel restrictions around the world.  The 2020 edition was slated to be 100% Ghanaian featuring designers and musicians from across the country.
                ...
                <div id="event-items" class="cbp cbp-l-grid-masonry-projects t-center">
                    ...
                    <a href="#" class="item cbp-item paris" data-bs-toggle="modal" data-bs-target="">
                        <div class="item-container" style="color: #B10DB7!important;">
                            ...
                            <div class="item-img">
                                ...
                                <img src="content/musician/images/rodr2020__1.jpg" alt="">
                            </div>
                            <!-- Texts -->
                    ...
                    <a href="#" class="item cbp-item madrid" data-bs-toggle="modal" data-bs-target="">
                        <div class="item-container">
                            ...
                            <div class="item-img">
                                <div class="city">#RODR20</div>
                                <img src="content/musician/images/rodr2020__2.jpg" alt="">
                            </div>
                            <!-- Texts -->
                    ...
                    <a href="#" class="item cbp-item istanbul" data-bs-toggle="modal" data-bs-target="#rodr2020">
                        <div class="item-container">
                            ...
                            <div class="item-img">
                                <div class="city">#RODR20</div>
                                <img src="content/musician/images/rodr2020__3.jpg" alt="">
                            </div>
                            <!-- Texts -->
                    ...
                    <!-- End Item -->
                     ...
                     <a href="#" class="item cbp-item paris" data-bs-toggle="modal" data-bs-target="">
                        <div class="item-container" style="color: #B10DB7!important;">
                            ...
                            <div class="item-img">
                                <div class="city">#RODR20</div>
                                <img src="content/musician/images/rodr2020__4.jpg" alt="">
                            </div>
                            <!-- Texts -->
                            {{-- <h2 class="item-title">Green Edition</h2>
                            <p class="item-city">View</p>
                    ...
                    <a href="#" class="item cbp-item madrid" data-bs-toggle="modal" data-bs-target="">
                        <div class="item-container">
                            ...
                            <div class="item-img">
                                <div class="city">#RODR20</div>
                                <img src="content/musician/images/rodr2020__5.jpg" alt="">
                            </div>
                            <!-- Texts -->
                            {{-- <h2 class="item-title">Masquerade Edition</h2>
                            <p class="item-city">View</p>
                    ...
                    {{-- <a href="#" class="item cbp-item istanbul" data-bs-toggle="modal" data-bs-target="#rodr2020">
                        <div class="item-container">
                            ...
                            <div class="item-img">
                                <div class="city">#RODR20</div>
                                <img src="content/musician/images/rodr2020__6.jpg" alt="">
                            </div>
...
<section id="player1" class="hidden player-section py-1" data-background="/content/musician/images/aquabgab.jpg">
