      ...
      <!-- Start Navigation -->
     <nav id="navigation" class="modern-nav fs-12 fixed bordered hover-dark link-hover-01 nav-dark dropdown-radius" data-offset="55">
        ...
        <div class="container-fluid nav-container">
            ...
            <div class="row nav-wrapper">
                ...
                <div class="col-auto">
                    <a href="#" class="logo">
                        <img src="{{asset('/images/logos/logo_02_white.png')}}" alt="website logo" class="logo-white">
                        <img src="{{asset('/images/logos/logo_02_dark.png')}}" alt="website logo" class="logo-dark">
                    </a>
                </div>
                ...
                <div class="col ml-auto nav-menu">
                    ...
                    <ul class="nav-links black justify-content-end">
...
{{--                        <li><a href="#updates" class="nav-link">News and Updates</a></li>--}}
{{--                        <li><a href="{{route('home1')}}" class="nav-link">Home1</a></li>--}}
{{--                        <li><a href="#player" class="nav-link">Listen Now</a></li>--}}
                        ...
                        <li class="extra-links">
                            ...
                            <a href="#prices" target="_blank" class="nav-button bg-colored bg-colored1-hover white fs-11 uppercase bold" title="Buy Quadra Now">Grab a Ticket</a>
                        </li>
                    </ul>
                </div>
                <!-- Mobile Nav Button -->
